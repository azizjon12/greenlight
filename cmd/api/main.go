...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "", "PosgreSQL DSN")
	...
	// We use the strings.Fields() function to split the flag value into a
	...
	// If the version flag value is true, then print out the version number and exit immediately
	if *displayVersion {
	...
	// Publish a new "version" var in the expvar handler having our app. version number (currently the constant "1.0.0")
